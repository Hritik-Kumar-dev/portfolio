    ...
    return (
        <nav className="flex items-center justify-between px-6 py-4 sticky text-gray-800 shadow-md  w-screen  top-0 bg-white z-10   ">
            ...
            <ul className="flex space-x-10 -translate-x-55 gap-5.5 poetsen-one-regular ">
                ...
                <Link to="contact" activeClass="active" spy={true} smooth={true} duration={500} className="hover:underline hover:text-[16.3px] cursor-pointer flex items-center gap-0.5 "> {<LiaHandshake />}Contact</Link>
            </ul>
